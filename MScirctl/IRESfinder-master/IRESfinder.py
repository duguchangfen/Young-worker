...
if sys.version_info[0] != 3 :
  print (sys.stderr, "\nYou are using python" + str(sys.version_info[0]) + '.' + str(sys.version_info[1]) + " IRESfinder needs python3.7!\n")
  sys.exit()
import os
import optparse
...
parse.add_option('-p','--poth_out',help='Output path',default='./')
...
temp_inPutFileName = options.poth_out + 'temp_inputfile.seq'
temp_outputlab = options.poth_out + 'tmp_outputlab.txt'
os.system('touch '+options.poth_out+'temp_inputfile.seq '+options.poth_out+'tmp_outputlab.txt')
...
if options.model == '2':
  ...
  #print('perl '+ IRESFINDERPATH + '/module/handlemodel2.pl '+ inPutFileName + ' '+ temp_inPutFileName + ' '+ temp_outputlab + ' '+ options.window + ' '+ options.step)
else:
...
#==============================================================================
temp_features = options.poth_out + 'tmp_features.txt'
